  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserCreateRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserCreateRecord> passwordresetUserCreateRecordList =
            snapshot.data!;
        final passwordresetUserCreateRecord =
            passwordresetUserCreateRecordList.isNotEmpty
                ? passwordresetUserCreateRecordList.first
                : null;
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    if (_model
                                        .tXTEmailTextController.text.isEmpty) {
