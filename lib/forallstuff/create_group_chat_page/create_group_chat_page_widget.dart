                                                                ...
                                                                children: [
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Checkbox(
                                                                        value: _model.checkboxValueMap1[listViewUserRecord] ??=
                                                                            false,
                                                                        onChanged:
                                                                            (newValue) async {
                                                                          setState(() =>
                                                                              _model.checkboxValueMap1[listViewUserRecord] = newValue!);
                                                                          if (newValue!) {
                                      ...
                                      child: Checkbox(
                                        ...
                                        onChanged: (newValue) async {
                                          setState(() => _model.checkboxValue2 =
                                              newValue!);
                                          if (newValue!) {
                                            FFAppState().checkBoxPublic = true;
                                            FFAppState().checkBoxPrivate =
                                                false;
                                          } else {
                                            FFAppState().checkBoxPublic = false;
                                            FFAppState().checkBoxPrivate = true;
                                          }
                                        },
                                        side: BorderSide(
                                          width: 2,
