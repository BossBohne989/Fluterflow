  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserCreateRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserCreateRecord> registrationUserCreateRecordList =
            snapshot.data!;
        final registrationUserCreateRecord =
            registrationUserCreateRecordList.isNotEmpty
                ? registrationUserCreateRecordList.first
                : null;
