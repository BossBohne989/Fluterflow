...
DocumentReference? get currentUserReference =>
    loggedIn ? UserCreateRecord.collection.doc(currentUser!.uid) : null;

UserCreateRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserCreateRecord.getDocument(UserCreateRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
