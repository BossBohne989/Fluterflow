...
import 'w_t_o_home_model.dart';
export 'w_t_o_home_model.dart';

class WTOHomeWidget extends StatefulWidget {
  const WTOHomeWidget({
    super.key,
    this.roundOne,
    this.roundTwo,
  ...
  final DateTime? roundOne;
  final DateTime? roundTwo;

  @override
  State<WTOHomeWidget> createState() => _WTOHomeWidgetState();
}

class _WTOHomeWidgetState extends State<WTOHomeWidget> {
  late WTOHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WTOHomeModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> wTOHomeRoomRecordList = snapshot.data!;
        final wTOHomeRoomRecord = wTOHomeRoomRecordList.isNotEmpty
            ? wTOHomeRoomRecordList.first
            : null;
