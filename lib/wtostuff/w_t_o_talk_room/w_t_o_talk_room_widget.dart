...
import 'w_t_o_talk_room_model.dart';
export 'w_t_o_talk_room_model.dart';

class WTOTalkRoomWidget extends StatefulWidget {
  const WTOTalkRoomWidget({super.key});

  @override
  State<WTOTalkRoomWidget> createState() => _WTOTalkRoomWidgetState();
}

class _WTOTalkRoomWidgetState extends State<WTOTalkRoomWidget> {
  late WTOTalkRoomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WTOTalkRoomModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> wTOTalkRoomRoomRecordList = snapshot.data!;
        final wTOTalkRoomRoomRecord = wTOTalkRoomRoomRecordList.isNotEmpty
            ? wTOTalkRoomRoomRecordList.first
            : null;
