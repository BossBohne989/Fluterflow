...
import 'w_t_o_pre_agenda_model.dart';
export 'w_t_o_pre_agenda_model.dart';

class WTOPreAgendaWidget extends StatefulWidget {
  const WTOPreAgendaWidget({
    super.key,
    this.topic,
  });
  ...
  @override
  State<WTOPreAgendaWidget> createState() => _WTOPreAgendaWidgetState();
}

class _WTOPreAgendaWidgetState extends State<WTOPreAgendaWidget> {
  late WTOPreAgendaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WTOPreAgendaModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> wTOPreAgendaRoomRecordList = snapshot.data!;
        final wTOPreAgendaRoomRecord = wTOPreAgendaRoomRecordList.isNotEmpty
            ? wTOPreAgendaRoomRecordList.first
            : null;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: StreamBuilder<List<SoloAgendaRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount:
                                        listViewSoloAgendaRecordList.length,
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              listViewGoalsRecord.goal.maybeHandleOverflow(maxChars: 52),
