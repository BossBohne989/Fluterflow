...
import 'members_pre_goals_model.dart';
export 'members_pre_goals_model.dart';

class MembersPreGoalsWidget extends StatefulWidget {
  const MembersPreGoalsWidget({super.key});

  @override
  State<MembersPreGoalsWidget> createState() => _MembersPreGoalsWidgetState();
}

class _MembersPreGoalsWidgetState extends State<MembersPreGoalsWidget> {
  late MembersPreGoalsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembersPreGoalsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> membersPreGoalsRoomRecordList = snapshot.data!;
        final membersPreGoalsRoomRecord =
            membersPreGoalsRoomRecordList.isNotEmpty
                ? membersPreGoalsRoomRecordList.first
                : null;
