...
import 'phase2_model.dart';
export 'phase2_model.dart';

class Phase2Widget extends StatefulWidget {
  const Phase2Widget({super.key});

  @override
  State<Phase2Widget> createState() => _Phase2WidgetState();
}

class _Phase2WidgetState extends State<Phase2Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Phase2Model());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> phase2RoomRecordList = snapshot.data!;
        final phase2RoomRecord =
            phase2RoomRecordList.isNotEmpty ? phase2RoomRecordList.first : null;
