  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> phase4RoomRecordList = snapshot.data!;
        final phase4RoomRecord =
            phase4RoomRecordList.isNotEmpty ? phase4RoomRecordList.first : null;
