  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> phase1RoomRecordList = snapshot.data!;
        final phase1RoomRecord =
            phase1RoomRecordList.isNotEmpty ? phase1RoomRecordList.first : null;
