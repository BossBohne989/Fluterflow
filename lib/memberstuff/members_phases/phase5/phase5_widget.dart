  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> phase5RoomRecordList = snapshot.data!;
        final phase5RoomRecord =
            phase5RoomRecordList.isNotEmpty ? phase5RoomRecordList.first : null;
