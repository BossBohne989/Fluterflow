...
import 'members_pre_agenda_model.dart';
export 'members_pre_agenda_model.dart';

class MembersPreAgendaWidget extends StatefulWidget {
  const MembersPreAgendaWidget({
    super.key,
    this.wto,
  });

  final List<String>? wto;

  @override
  State<MembersPreAgendaWidget> createState() => _MembersPreAgendaWidgetState();
}

class _MembersPreAgendaWidgetState extends State<MembersPreAgendaWidget> {
  late MembersPreAgendaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembersPreAgendaModel());
    ...
    return StreamBuilder<List<RoomRecord>>(
      stream: queryRoomRecord(
        singleRecord: true,
          ...
          List<RoomRecord> membersPreAgendaRoomRecordList = snapshot;
          final membersPreAgendaRoomRecord =
              membersPreAgendaRoomRecordList.isNotEmpty
                  ? membersPreAgendaRoomRecordList.first
                  : null;
          if (_model.membersPreAgendaPreviousSnapshot != null &&
              !const ListEquality(RoomRecordDocumentEquality()).equals(
                  membersPreAgendaRoomRecordList,
                  _model.membersPreAgendaPreviousSnapshot)) {
            _model.out = await RoomRecord.getDocumentOnce(
                membersPreAgendaRoomRecord!.reference);
            if (_model.out?.talkStart == true) {
              context.pushNamed('MembersPreTalkRoom');
            }

            setState(() {});
          }
          _model.membersPreAgendaPreviousSnapshot = snapshot;
        }),
      builder: (context, snapshot) {
        ...
        List<RoomRecord> membersPreAgendaRoomRecordList = snapshot.data!;
        final membersPreAgendaRoomRecord =
            membersPreAgendaRoomRecordList.isNotEmpty
                ? membersPreAgendaRoomRecordList.first
                : null;
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          if (containerUserRecord?.teamLeader ??
                                                                              true)
                                                                            Align(
