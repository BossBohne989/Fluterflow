                            ...
                            Expanded(
                              child: Stack(
                                children: [
                                  ...
                                  if (FFAppState().MemberAbkommenCreate)
                                    Align(
                                      alignment: AlignmentDirectional(0.0, 0.0),
                                      child: StreamBuilder<List<UserRecord>>(
                                        stream: queryUserRecord(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<UserRecord>
                                              containerCreateAbkommenUserRecordList =
                                              snapshot.data!;
                                          final containerCreateAbkommenUserRecord =
                                              containerCreateAbkommenUserRecordList
                                                      .isNotEmpty
                                                  ? containerCreateAbkommenUserRecordList
                                                      .first
                                                        ...
                                                        return FFButtonWidget(
                                                          onPressed: () async {
                                                            ...
                                                            if (buttonAgreementRecord
                                                                    ?.teams
                                                                    ?.contains(
                                                                        containerCreateAbkommenUserRecord
                                                                            ?.team) !=
                                                                true) {
                                                              await _model
                                                                  .agreement!
                                  ...
                                  if (FFAppState().MemberAbkommenInfo)
                                    Container(
                                      width: 558.0,
                                      decoration: BoxDecoration(
                                        color: Color(0xFF153172),
