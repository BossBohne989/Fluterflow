...
import 'members_talk_room_model.dart';
export 'members_talk_room_model.dart';

class MembersTalkRoomWidget extends StatefulWidget {
  const MembersTalkRoomWidget({super.key});

  @override
  State<MembersTalkRoomWidget> createState() => _MembersTalkRoomWidgetState();
}

class _MembersTalkRoomWidgetState extends State<MembersTalkRoomWidget> {
  late MembersTalkRoomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembersTalkRoomModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<RoomRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomRecord> membersTalkRoomRoomRecordList = snapshot.data!;
        final membersTalkRoomRoomRecord =
            membersTalkRoomRoomRecordList.isNotEmpty
                ? membersTalkRoomRoomRecordList.first
                : null;
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        await TalkRoomRecord.createDoc(
                                                                membersTalkRoomRoomRecord!
                                                                    .reference)
                                                            .set(
                                                                createTalkRoomRecordData(
                                                          teamname:
                                                              containerUserRecord
                                                                  ?.team,
                                                          teamIMG:
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(
                                                                ...
                                                                0.0),
                                                    child: Text(
                                                      'Here you can request time to give an oral statement in front of the plenum.',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 5.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Thoses members already requested speaking time.',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: FlutterFlowTheme
                                                              .of(context)
